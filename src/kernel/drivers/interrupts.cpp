...
void init_idt() {
    // IDT setup code will go here
    // You need to initialize the IDT entries for handling hardware/software interrupts
    // For simplicity, this can be a placeholder
}

// Enable interrupts (set the interrupt flag in the EFLAGS register)
void enable_interrupts() {
    __asm__ __volatile__ ("sti");  // Set Interrupt Flag (IF)
}
